    ...
    j$.service.create("Assunto",      
          {
              initialize: function(UpdateController) {}
            ...
            , resource:{name:'assunto', id:'idAssunto', local:true, cache:true}
