...
var CONFIG = {
   ...
   ,   SERVER:{CONTEXT:'http://localhost/jah/'}      
   ...
   , MASK:{
    ...
    , ACTION:{
           BACK:{KEY:'back',   VALUE:'Voltar'   , ICON:'iconic-o-arrow-left'}
       , SEARCH:{KEY:'search', VALUE:'Pesquisar', ICON:'icon-search'}
       ,    NEW:{KEY:'new',    VALUE:'Incluir'  , ICON:'iconic-o-plus' 
                , MESSAGE:{
       ...
       ,   SAVE:{KEY:'save',   VALUE:'Salvar'   , ICON:'iconic-o-check'
                , MESSAGE:{
       ...
       ,   NEXT:{KEY:'next',   VALUE:'Próximo'  , ICON:'iconic-o-arrow-right'}
       ,   LAST:{KEY:'last',   VALUE:'Último'   , ICON:''}
       ,  CLOSE:{KEY:'close',  VALUE:'Fechar'   , ICON:'iconic-o-x'}
       ,   HOME:{KEY:'home',   VALUE:'Início'   , ICON:'iconic-home'}
       ,   UNDO:{KEY:'undo',   VALUE:'Desfazer' , ICON:'iconic-undo'}
       , FILTER:{KEY:'Filter', VALUE:'Filtrar'  , ICON:'icon-filter'}
       ,   SORT:{KEY:'sort',   VALUE:'Ordenar'  , ICON:''}
       ,     OK:{KEY:'ok',     VALUE:'OK'       , ICON:'iconic-o-check', COLOR:'#51A351'}
       , CANCEL:{KEY:'cancel', VALUE:'Cancelar' , ICON:'iconic-o-arrow-left', COLOR:'#BD362F'}
       ,  ERROR:{KEY:'error',  VALUE:'Erro'     , ICON:'ikon-error'}
       ,   INFO:{KEY:'info',   VALUE:'Nota'     , ICON:'ikon-info'} 
       ,    YES:{KEY:'yes',    VALUE:'Sim'      , ICON:'iconic-o-check', COLOR:'#51A351'} 
       ,     NO:{KEY:'no',     VALUE:'Não'      , ICON:'iconic-o-arrow-left', COLOR:'#BD362F'}        
    ...
    , BUTTON:{CLASS:{DEFAULT:'btn', GRID:'btn btn-small'}}
    , PAGER:{CLASS:'pagination pagination-small'}
};
//
//CONFIG.ICON ={new:'iconic-o-plus' , search:'icon-search',   edit:'icon-edit'  , save:'iconic-o-check' 
//          , print:'icon-print'    ,  trash:'icon-trash' , filter:'icon-filter', back:'iconic-o-arrow-left', next:'iconic-o-arrow-right'
//          ,    ok:'iconic-o-check',  close:'iconic-o-x',    home:'iconic-home', undo:'iconic-undo'}; 
